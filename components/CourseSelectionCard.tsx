  ...
  return (
    <div className="flex flex-wrap gap-6">
      ...
      <div className="flex-1 min-w-[140px] space-y-2">
        ...
        <input
          className={`w-full rounded-xl border px-3 py-2 text-sm font-medium text-gray-700 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all ${course.schoolYear ? 'text-gray-900' : 'text-gray-400'} ${getFieldClass('schoolYear' as any)}`}
